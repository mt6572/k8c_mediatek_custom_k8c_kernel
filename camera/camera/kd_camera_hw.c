/* Copyright Statement:
 1028Switch sub back will become green .
 *
...
u32 Count_af=0; //ugrec_tky
void pwr_on_AF()
{
hwPowerDown(CAMERA_POWER_VCAM_A2,"121");//add by leon
mDELAY(200);// add by leon for kalakala 3
hwPowerOn(CAMERA_POWER_VCAM_A2, VOL_2800,"121");
}
...
int kdCISModulePowerOn(CAMERA_DUAL_CAMERA_SENSOR_ENUM SensorIdx, char *currSensorName, BOOL On, char* mode_name)
{
    ...
    if (On) {
	  ...
	  // MainCameraDigtalPowerCtrl(1);
       ...
       {
		   PK_DBG("[CAMERA SENSOR] kdCISModulePowerOn get in---SENSOR_DRVNAME_OV3660_YUV sensorIdx:%d; pinSetIdx=%d\n",SensorIdx, pinSetIdx);
		...
		//   msleep(5);
	   	...
	   	#endif
	   	if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC2145_YUV,currSensorName)))
       {
		   PK_DBG("[CAMERA SENSOR] kdCISModulePowerOn get in---SENSOR_DRVNAME_gc2145_YUV sensorIdx:%d; pinSetIdx=%d\n",SensorIdx, pinSetIdx);
...
//hwPowerDown(CAMERA_POWER_VCAM_A2,"121"); // add by leon for kalakala 4
